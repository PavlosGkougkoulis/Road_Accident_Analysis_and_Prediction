...
df = pd.read_excel("E:/University/Thesis/Thesis_Main/Thesis_Code/Python/Main_Code/Monthly_LSTM/Accidents_LSTM_Prediction/Accident_Forecast_DFs/Accidents_Forecast_Df.xlsx")
...
plt.figure(figsize=(10, 4))
plt.plot(rolling_error, label="4-Month Rolling MAE", color="orange")
